...
def export_to_csv(modeladmin, request, queryset):
    ...
    # Create a CSV writer using the response
    writer = csv.writer(response)
    # Get the fields of the model (excluding many-to-many and one-to-many fields)
    ...
    # Return the HTTP response with CSV content
    return response
